...
~~~sh
# getting the code
git clone git@github.com:nko4/make-it-so.git && cd ./make-it-so/

# developing
npm install
npm start

# deploying (to http://make-it-so.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@make-it-so.2013.nodeknockout.com
ssh root@make-it-so.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@make-it-so.2013.nodeknockout.com
ssh -i ./id_deploy root@make-it-so.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/make-it-so" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
